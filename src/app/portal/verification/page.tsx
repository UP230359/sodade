...
export default function VerificationPage() {
  ...
  const loadVerification = async () => {
    setLoading(true);
    try {
      const data = await getVerificationStatus(1); // TODO: Obtener del usuario logueado
        ...
        <div className="p-5 md:p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between pb-4 border-b border-[#F4F4F4]">
              ...
              <span className="text-sm text-[#333333]">{verification?.primary_specialty || "Not specified"}</span>
            </div>
